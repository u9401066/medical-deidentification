...
def run_langchain_mapreduce(
    ...
    """
    from core.infrastructure.rag.chains.map_reduce import identify_phi_with_map_reduce
...
def main():
    ...
    print("[Init] Creating LangChain LLM...", flush=True)
    config = LLMConfig(
        provider="ollama",
    ...
    print("[Init] Creating MedicalTextSplitter...", flush=True)
