...
class LangChainPHIDetector:
    ...
    def __init__(self, model_name: str = "qwen2.5:1.5b", language: str = "en"):
        ...
        self.system_message = """You are an expert Named Entity Recognition (NER) system.
...
If no PHI is found, return an empty list."""
        ...
        print("  ✓ Using PHIDetectionResponse structured output")

    def detect(self, text: str) -> tuple[list[str], PHIDetectionResponse | None]:
        """
        Detect PHI in text
