...
def configure_logging(
    ...
    if enable_file:
        ...
        log_file = log_dir / f"medical_deidentification_{timestamp}.log"
...
def get_module_logger(module_name: str):
    ...
    Examples:
        >>> from medical_deidentification.infrastructure.utils import get_module_logger
...
def disable_logging():
    ...
    Examples:
        >>> from medical_deidentification.infrastructure.utils import disable_logging
        >>> disable_logging()
    """
    logger.remove()
    logger.disable("medical_deidentification")
...
def enable_logging():
    ...
    Examples:
        >>> from medical_deidentification.infrastructure.utils import enable_logging
        >>> enable_logging()
    """
    logger.enable("medical_deidentification")
