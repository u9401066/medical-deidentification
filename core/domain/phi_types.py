...
class CustomPHIType:
    ...
    pattern: str | None = None  # Regex pattern for detection | 檢測用的正則表達式
    examples: list[str] = field(default_factory=list)  # Example values | 範例值
    regulation_source: str | None = None  # Source regulation | 來源法規
    is_high_risk: bool = False  # High identification risk | 高識別風險
    masking_strategy: str | None = None  # Recommended masking strategy | 建議的遮罩策略
