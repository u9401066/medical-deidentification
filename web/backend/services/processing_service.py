...
from config import OLLAMA_BASE_URL, OLLAMA_MODEL, RESULTS_DIR, REPORTS_DIR
            ...
            for doc_result in result.document_results:
                if hasattr(doc_result, "phi_entities"):
                    for entity in doc_result.phi_entities:
                        phi_entities.append({
                            "type": entity.phi_type.value if hasattr(entity.phi_type, 'value') else str(entity.phi_type),
    ...
    def save_report(
        ...
        report = {
            ...
            "summary": {
                ...
                "processing_speed_chars_per_sec": total_chars / processing_time if processing_time > 0 else 0,
            },
            "file_details": [
                {
